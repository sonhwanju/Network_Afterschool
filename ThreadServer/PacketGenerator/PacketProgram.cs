...
namespace PacketGenerator
{
    class PacketProgram
    {
        ...
        private static Tuple<string,string,string> ParseList(XmlReader r)
        {
            ...
            (string member, string read, string write) = ParseMember(r);
            string memberCode = string.Format(PacketFormat.memberListFormat, FirstUpper(listName), FirstLower(listName),member,read,write);
            string readCode = string.Format(PacketFormat.listReadFormat, FirstUpper(listName), FirstLower(listName));
            string writeCode = string.Format(PacketFormat.listWriteFormat, FirstUpper(listName), FirstLower(listName));
